 ...
 * 根据用户名获取的活动列表
 */
@WebServlet("/activity/getSomeActivityByName")
public class GetSomeActivityByNameServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(!"".equals(sb.toString())) {
            ...
            if(name!=null){
                ...
                List<Activity> activities = service.getSomeActivityByName(name.toString());
