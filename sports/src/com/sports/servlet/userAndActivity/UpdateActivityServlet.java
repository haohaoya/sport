 ...
 * 修改活动信息接口
 */
@WebServlet("/userAndActivity/updateActivity")
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(!"".equals(sb.toString())) {
            ...
            if(name!=null){
                ...
                if(userAndActivityService.updateActivity(sessionUser.getUsername(),name.toString(),information.toString(),category.toString())==0) {
                    //修改成功
                    //返回成功json
